const zhCN = {
  ...
  page: {
    ...
    annotation: {
      title: '注释',
      breadcrumbLabel: '注释页面导航',
      searchPanelLabel: '注释数据筛选',
      searchControlsLabel: '注释搜索条件，窄屏时可横向滚动',
      horizontalScrollHint: '使用左右方向键或触控横向滚动以查看全部搜索条件。',
      accession: '品种编号',
      accessionFieldLabel: '品种编号',
      assemblyFieldLabel: '组装版本',
      annotationFieldLabel: '注释版本',
      chromosomeFieldLabel: '染色体筛选',
      featureFieldLabel: '特征类型筛选',
      currentData: '当前数据',
      noContextSelected: '尚未选择数据',
      resetFilters: '重置筛选',
      viewMode: '视图模式',
      ...
      summaryLabel: '注释数据统计',
      totalFeaturesLabel: '总特征数',
      chromosomeCountLabel: '染色体数',
      featureTypeCountLabel: '特征类型数',
      resultsRegionLabel: '注释查询结果',
      loadingData: '正在加载注释数据',
      retryData: '重新加载',
      paginationLabel: '注释结果分页',
      visualizationLabel: '染色体注释图形',
      featureControlsLabel: '图形显示特征类型',
      rowLengthInputLabel: '每行长度，单位 {unit}',
      decreaseRowLength: '减小每行长度',
      increaseRowLength: '增加每行长度',
      ...
      assemblyBreadcrumb: '基因组',
      assembly: '组装版本',
      selectAssembly: '选择组装版本',
      annotation: '注释版本',
      selectAnnotation: '选择注释版本',
