const zhCN = {
  ...
  page: {
    ...
    accessionPortal: {
      ...
      mapDescription: '展示具有有效采集坐标的品种，气泡大小代表该区域的品种数量。',
      viewFullMap: '查看详细地理分布',
      fitDataView: '适应数据',
      globalView: '全球视图',
      mapEmpty: '暂无可展示的地理数据',
      mapAriaLabel: '地理分布图，已映射 {mapped} / 共 {total} 个品种',
      numberOfAccessions: '品种数量',
      mappedOfTotal: '有效坐标 {mapped} / 品种总数 {total}',
      regionCount: '{count} 个聚合区域',
      unmappedCount: '{count} 个品种缺少有效坐标',
      topRegions: '主要分布地区',
    ...
    accessionMap: {
      eyebrow: '品种信息 / 地理分布',
      description: '按品种、地区或亚群筛选具有有效采集坐标的品种，并从聚合区域进入具体品种。',
      backToOverview: '返回品种信息',
      filters: '地理分布筛选条件',
      ...
      allSubPopulations: '全部亚群',
      resetFilters: '重置筛选',
      resultSummary: '当前显示 {mapped} / {total} 个已定位品种，分布于 {regions} 个 2° 聚合区域',
      mapTitle: '品种采集地分布',
      mapHint: '拖动或缩放地图；点击气泡可查看该区域内的品种。',
      ...
      gridNotice: '坐标按 2° 网格聚合；原始坐标不会被修改。',
