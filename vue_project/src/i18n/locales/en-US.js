const enUS = {
  ...
  page: {
    ...
    assembly: {
      ...
      portalSubtitle: 'Search and browse genome assembly versions, revisit recent records, and explore assembly information.',
      searchTitle: 'Search Assembly',
      searchPlaceholder: 'Search accession / public assembly ID / assembly name ...',
      examples: 'Examples',
      searchExample: 'Search Assembly example {example}',
    ...
    accessionPortal: {
      ...
      mapDescription: 'Accessions with valid collection coordinates; bubble size represents the number of accessions in each area.',
      viewFullMap: 'Explore Detailed Distribution',
      ...
      mappedOfTotal: '{mapped} with valid coordinates / {total} total',
      regionCount: '{count} aggregated areas',
      unmappedCount: '{count} accessions without valid coordinates',
    ...
    accessionDetail: {
      backToMap: 'Back to geographic distribution',
      backToAccessions: 'Back to Accessions',
    ...
    accessionMap: {
      eyebrow: 'Accessions / Geographic distribution',
      description: 'Filter accessions with valid collection coordinates by accession, region, or subpopulation, then inspect the records in each aggregated area.',
      backToOverview: 'Back to Accessions',
      ...
      resultSummary: 'Showing {mapped} of {total} located accessions across {regions} aggregated 2° regions',
      mapTitle: 'Collection-site distribution',
      mapHint: 'Pan or zoom the map. Select a bubble to review accessions in that area.',
      ...
      gridNotice: 'Coordinates are aggregated into 2° grids; source coordinates remain unchanged.',
