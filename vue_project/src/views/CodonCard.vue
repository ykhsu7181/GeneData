            ...
            <div class="nucleotide-composition">
              ...
              <div class="nucleotide-chart">
                <div class="nucleotide-bars">
                  <div class="nucleotide-bar" v-for="nucleotide in nucleotideData" :key="nucleotide.name">
...
export default {
  ...
  setup() {
    ...
    const handleRouteParams = () => {
      const organism = route.query.accession || route.query.organism;
    ...
    // 监听路由变化
    watch(() => route.query.accession || route.query.organism, (newOrganism) => {
