<template>
  <article class="shortcut-card" aria-labelledby="favorites-title">
    <header class="card-heading">
      <h2 id="favorites-title"><span aria-hidden="true">☆</span>{{ $t('page.accessionPortal.favorites') }}</h2>
...
.remove-favorite { border:0; background:transparent; color:#f2b705; font-size:17px; cursor:pointer; }
